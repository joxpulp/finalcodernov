 ...
 */
router.patch('/edituser', auth_2.isAuth, validate_1.validate(yup_1.editUser), auth_1.authController.editUser);
/**
 * @swagger
 * /auth/logout:
 *   get:
 ...
 *                   example: false
 */
router.get('/isloggedin', auth_1.authController.isLoggedIn);
