 ...
 *
 */
router.get('/list/:category?', productsByCat_1.productsByCat, products_1.productController.getProductsCat);
/**
 * @swagger
 * /products/add:
 *   post:
 ...
 */
router.post('/add', auth_1.isAuth, validate_1.validate(yup_1.addProduct), products_1.productController.addProduct);
/**
 * @swagger
 * /products/update/{id}:
 *   patch:
 ...
 */
router.patch('/update/:id', auth_1.isAuth, productExist_1.productExist, validate_1.validate(yup_1.editProduct), products_1.productController.updateProduct);
/**
 * @swagger
 *
 * /products/delete/{id}:
 ...
 *
 */
router.delete('/delete/:id', auth_1.isAuth, productExist_1.productExist, products_1.productController.deleteProduct);
