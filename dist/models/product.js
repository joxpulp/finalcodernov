...
var Product = /** @class */ (function () {
    ...
    Product.prototype.getByCategory = function (category) {
        return __awaiter(this, void 0, void 0, function () {
            var outputGet, catFormatter, productsByCat;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        outputGet = [];
                        catFormatter = category.charAt(0).toUpperCase() + category.slice(1).toLowerCase();
                        return [4 /*yield*/, productschema_1.products.find({ category: catFormatter })];
                    case 1:
                        productsByCat = _a.sent();
                        if (productsByCat)
                            outputGet.push.apply(outputGet, productsByCat);
