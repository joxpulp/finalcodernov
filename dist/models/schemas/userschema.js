    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = this;
                    return [4 /*yield*/, bcrypt_1.default.hash(user.pwd, 10)];
                case 1:
                    hash = _a.sent();
                    this.pwd = hash;
                    next();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = this;
                    if (!user._update.$set.pwd) return [3 /*break*/, 2];
                    return [4 /*yield*/, bcrypt_1.default.hash(user._update.$set.pwd, 10)];
                case 1:
                    hash = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = this;
                    return [4 /*yield*/, bcrypt_1.default.compare(password, user.pwd)];
                case 1:
                    compare = _a.sent();
