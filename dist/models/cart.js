...
var Cart = /** @class */ (function () {
    ...
    Cart.prototype.add = function (userId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            var findProduct, findProductCart, ouputNew;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Cart.prototype.delete = function (userId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            var findProduct, outputDelete, findById;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.get(userId, productId)];
                    case 1:
                        findProduct = (_a.sent())[0];
                        outputDelete = [];
                    ...
                    case 3:
                        findById = _a.sent();
                        if (!(findById.cartProducts.length === 0)) return [3 /*break*/, 5];
