...
var signupFunc = function (req, username, password, done) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, pwd, name, age, phone, admin, streetName, streetNumber, postalCode, floor, apt, user, randomAvatar, _b, secure_url, public_id, newUser;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = req.body, email = _a.email, pwd = _a.pwd, name = _a.name, age = _a.age, phone = _a.phone, admin = _a.admin, streetName = _a.streetName, streetNumber = _a.streetNumber, postalCode = _a.postalCode, floor = _a.floor, apt = _a.apt;
