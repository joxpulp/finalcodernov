...
var loginFunc = function (req, username, password, done) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, userschema_1.userModel.findOne({ email: username })];
            case 1:
                user = _b.sent();
                _a = !user;
...
var signupFunc = function (req, username, password, done) { return __awaiter(void 0, void 0, void 0, function () {
    var data, user, tempFilePath, _a, secure_url, public_id, newUser, _b, _c, _d, _e, _f;
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 3:
                _a = _g.sent(), secure_url = _a.secure_url, public_id = _a.public_id;
                data.avatar = secure_url;
                data.avatar_id = public_id;
                _g.label = 4;
            case 4:
                newUser = new userschema_1.userModel(data);
                return [4 /*yield*/, newUser.save()];
            case 5:
                _g.sent();
                _c = (_b = email_1.email).sendEmail;
                _d = [config_1.CONFIG.GMAIL_EMAIL, 'Nuevo Registro'];
                _f = (_e = JSON).stringify;
                return [4 /*yield*/, userschema_1.userModel.findOne({ email: req.body.email })];
            case 6: return [4 /*yield*/, _c.apply(_b, _d.concat([_f.apply(_e, [_g.sent(), null, 2])]))];
            case 7:
                _g.sent();
