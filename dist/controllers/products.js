...
var ProductController = /** @class */ (function () {
    ...
    ProductController.prototype.getProduct = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, findById, productQuery, findAll, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, product_1.productModel.query(req.query)];
                    case 3:
                        productQuery = _a.sent();
                    ...
                    case 4: return [4 /*yield*/, product_1.productModel.get()];
                    case 5:
                        findAll = _a.sent();
    ...
    ProductController.prototype.addProduct = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var data, tempFilePath, _a, secure_url, public_id, newProduct, error_2;
    ...
    ProductController.prototype.updateProduct = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, product, data, tempFilePath, _a, secure_url, public_id, updatedProduct, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 6, , 7]);
    ...
    ProductController.prototype.deleteProduct = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, product, deletedProduct, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
